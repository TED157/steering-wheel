...
//  打符云台参数
//  YAW轴角速度环
#define YAW_SPEED_AIMBOT_RUNES_KP               380.0f
...
#define PITCH_ANGLE_AIMBOT_RUNES_KD             170.0f
